...
// ideal screen dimensions 1920 x 1080 -- use own window width for game. NO scaling on objects, however
canvas.width = window.innerWidth;   //     window.innerWidth; 1920
canvas.height = window.innerHeight;   //    window.innerHeight; 1080
...
function drawText (text, xPosition, yPosition, size, color) {
    context.font = "" + size + "px Monaco, Monospace"; // changed font from px Comic Sans MS
    context.fillStyle = color;
